# Bowling Game Kata for Test-Driven Development
...
You should already have `homebrew` (not used), `npm`, `node`, `fnm` (or other Node version manager).

After `git clone` the repository to your local, run `npm install` in this repository's root.
